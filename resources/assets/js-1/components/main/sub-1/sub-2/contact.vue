        ...
        <div v-show="view == 'contacts'">
            <nav class="level">
                ...
                <div class="level-left">
                    ...
                    <div class="level-item">
                        <a @click.prevent="appendToSMS" class="button is-small is-rounded">
                                <span class="icon">
            ...
            <div class="content">
                <table-component
                    ...
                    <table-column show="d_id" label="MODIFY">
                        <template class="has-text-centered" slot-scope="row">
                            <a @click="edit" class="button is-rounded is-info is-small" :data-edit="row.d_id">
                                <span :data-edit="row.d_id" class="icon">
                                <i :data-edit="row.d_id" class="fas fa-user-edit"></i>
                                </span>
                                <!-- <span :data-edit="row.d_id"></span> -->
                            </a>
                    ...
                    <tbody>
                        <tr :ref="data.id" v-for="(data, index) in table" :key="index">
                            ...
                            <td data-label="MODIFY">
                                <a @click="edit" class="button is-rounded is-info is-small" :data-edit="data.d_id">
                                    <span :data-edit="data.d_id" class="icon">
                                    <i :data-edit="data.d_id" class="fas fa-user-edit"></i>
                                    </span>
        ...
        <div v-show="view == 'groups'">
            ...
            <div class="content">
                <table-component
                    ...
                    <table-column show="d_id" label="MODIFY">
                        <template class="has-text-centered" slot-scope="row">
                            <a @click="editGroup" class="button is-rounded is-info is-small" :data-groupedit="row.d_id">
                                <span :data-groupedit="row.d_id" class="icon">
                                <i :data-groupedit="row.d_id" class="fas fa-user-edit"></i>
                                </span>
                                <!-- <span :data-edit="row.d_id">{{ row.first_name }}</span> -->
                            </a>
                            <!-- <button @click="edit" type="checkbox" :data-edit="row.id">EDIT</button> -->
                ...
                <table id="table" class="table is-fullwidth table is-borderedd is-striped is-narrow is-hoverable is-fullwidth is-hidden-desktop is-hidden-tablet">
                    ...
                    <tbody>
                        <tr :ref="data.id" v-for="(data, index) in groups" :key="index">
                            ...
                            <td data-label="MODIFY">
                                <a @click="editGroup" class="button is-rounded is-info is-small" :data-groupedit="data.d_id">
                                    <span :data-groupedit="data.d_id" class="icon">
                                    <i :data-groupedit="data.d_id" class="fas fa-user-edit"></i>
                                    </span>
                                    <!-- <span :data-edit="row.d_id">{{ row.first_name }}</span> -->
                                </a>
                            </td>
...
export default {
  ...
  methods: {
    ...
    changeForG($) {
      this.els.push($.target.parentElement.parentElement);
      if ($.target.checked == true) {
        this.delete.push($.target.dataset.groupref);
      } else if ($.target.checked == false) {
