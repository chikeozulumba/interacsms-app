                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Cabin, Arial, sans-serif; color: #666666;" class="padding-copy">Dear {{ $name }}, thank you for registering for an account on InteracSMS, kindly click the link to verify your account.</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
